...
import GpuNodesTab from '~/components/@settings/tabs/gpu-nodes/GpuNodesTab';
...
const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'service-status': 'Monitor local services (Ollama, LM Studio, Appwrite)',
  connection: 'Check connection status and settings',
  debug: 'Debug tools and system information',
  'event-logs': 'View system events and logs',
  update: 'Check for updates and release notes',
  'task-manager': 'Monitor system resources and processes',
  'gpu-nodes': 'Manage remote GPU compute nodes for LLM processing',
  'tab-management': 'Configure visible tabs and their order',
};

// Beta status for experimental features
const BETA_TABS = new Set<TabType>(['task-manager', 'service-status', 'update', 'local-providers', 'gpu-nodes']);
